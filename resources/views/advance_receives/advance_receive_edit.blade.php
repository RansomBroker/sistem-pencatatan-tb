            ...
            <form method="POST" action="{{ URL::to('advance-receive/advance-receive-edit/edit') }}">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-12 col-lg-12">
                        ...
                        <select name="customer-id" id="customerID" data-type="customer-id" class="form-control @error('customer-id') is-invalid @enderror">
                            <option value="{{ $advanceReceive->customers[0]->id  }}" selected>{{ $advanceReceive->customers[0]->name }} ({{ $advanceReceive->customers[0]->customer_id }})</option>
                        </select>
                        @error('customer-id')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="mb-3 col-12 col-lg-12">
                        ...
                        <input type="text" class="form-control @error('memo') is-invalid @enderror" placeholder="Ketikan memo" name="memo" value="{{ $advanceReceive->memo }}"/>
                        @error('memo')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
