...
return new  class extends Migration
{
    ...
    public function up()
    {
        Schema::table('advance_receives', function (Blueprint $table) {
            $table->decimal('buy_price', 16, 9)->nullable()->change();
            $table->decimal('net_sale', 16, 9)->nullable()->change();
            $table->decimal('tax', 16, 9)->nullable()->change();
            $table->decimal('unit_price', 16, 9)->nullable()->change();
            $table->decimal('idr_total', 16, 9)->nullable()->change();
            $table->decimal('idr_expired', 16, 9)->nullable()->change();
            $table->decimal('idr_refund', 16, 9)->nullable()->change();
            $table->decimal('idr_sum_all', 16, 9)->nullable()->change();
            $table->decimal('idr_remains', 16, 9)->nullable()->change();
        });
    }
