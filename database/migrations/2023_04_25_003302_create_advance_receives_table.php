...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('advance_receives', function (Blueprint $table) {
            ...
            $table->decimal('idr_total', 16, 9)->nullable();
            $table->integer('qty_expired')->nullable();
            $table->decimal('idr_expired', 16, 9)->nullable();
            $table->integer('qty_refund')->nullable();
            $table->decimal('idr_refund', 16, 9)->nullable();
            $table->integer('qty_sum_all')->nullable();
            $table->decimal('idr_sum_all', 16, 9)->nullable();
            $table->integer('qty_remains')->nullable();
            $table->decimal('idr_remains', 16, 9)->nullable();
